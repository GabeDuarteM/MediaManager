...
namespace ConfigurableInputMessageBox
{
    ...
    ///     No construtor é informado um enum inputType (caso não informado é utilizado o inputType.Default) contendo as
    ...
    ///     Message = Mensagem informativa da janela (Exemplo: "Informe um valor..."). Esta mensagem é exibida como Placeholder
    ///     da caixa de texto.
    ...
    public class InputMessageBoxProperties : INotifyPropertyChanged, IDataErrorInfo
    {
        ...
        public Thickness MarginOkButton
        {
            get { return new Thickness(10, 10, ButtonWidth + 15, 10); }
        }
    ...
    public class InputMessageBoxViewModel : INotifyPropertyChanged
    {
        ...
        public InputMessageBoxProperties Properties { get; }
    ...
    {
        private readonly InputMessageBoxViewModel _inputVM;
