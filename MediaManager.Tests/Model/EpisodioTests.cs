...
namespace MediaManager.Tests.Model
{
    [TestClass]
    public class EpisodioTests
    {
        public EpisodioTests()
        {
            Startup.OnStartUp();
        }
        ...
        public void TestarSeriesRegexS00E00()
        {
            ...
            episodio = new Episodio {sDsFilepath = "Arrow.S04E01.Green.Arrow.1080p.WEB-DL.6CH.x265.HEVC-PSA"};
            ...
            episodio = new Episodio {sDsFilepath = "Falling Skies S05E07 720p WEB-DL x264-Belex - Dual Audio"};
            if (episodio.IdentificarEpisodio())
            {
                episodio.oSerie.sFormatoRenomeioPersonalizado = formatoRenomeio;
                nomeRenomeado = Helper.RenomearConformePreferencias(episodio);
            ...
            episodio.sDsFilepath =
                "The.Big.Bang.Theory.S08E19.The.Skywalker.Incursion.720p.WEB-DL.DD5.1.AAC2.0.H.264-YFN";
            if (episodio.IdentificarEpisodio())
            {
                episodio.oSerie.sFormatoRenomeioPersonalizado = formatoRenomeio;
                nomeRenomeado = Helper.RenomearConformePreferencias(episodio);
        ...
        public void TestarSeriesRegexFansub0000()
        {
            ...
            episodio = new Episodio {sDsFilepath = "[HorribleSubs] Sword Art Online - 01 [720p]"};
            if (episodio.IdentificarEpisodio())
            {
                episodio.oSerie.sFormatoRenomeioPersonalizado = formatoRenomeio;
                nomeRenomeado = Helper.RenomearConformePreferencias(episodio);
