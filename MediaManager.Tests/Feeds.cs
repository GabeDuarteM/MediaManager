...
namespace MediaManager.Tests
{
    ...
    public class Feeds
    {
        ...
        public void FeedsPrioridades()
        {
            ...
            Feed feed6 = new Feed() { nCdFeed = 6, bFlSelecionado = false, nIdTipoConteudo = Helpers.Enums.ContentType.show, nNrPrioridade = 1 };
            Feed feed7 = new Feed() { nCdFeed = 7, bFlSelecionado = true, nIdTipoConteudo = Helpers.Enums.ContentType.show, nNrPrioridade = 2 };
            Feed feed8 = new Feed() { nCdFeed = 8, bFlSelecionado = false, nIdTipoConteudo = Helpers.Enums.ContentType.show, nNrPrioridade = 3 };
            Feed feed9 = new Feed() { nCdFeed = 9, bFlSelecionado = true, nIdTipoConteudo = Helpers.Enums.ContentType.show, nNrPrioridade = 4 };
            Feed feed10 = new Feed() { nCdFeed = 10, bFlSelecionado = false, nIdTipoConteudo = Helpers.Enums.ContentType.show, nNrPrioridade = 5 };
